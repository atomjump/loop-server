...
} ?>" onclick="event.stopPropagation(); return true;" style="margin-bottom:3px;"><img id="video-button" src="<?php echo $root_server_url ?>/images/video.svg" title="Video Chat" style="width: 48px; height: 32px;"></a><a target="_blank" href="subscribe.php" onclick="event.stopPropagation(); return true;" style="margin-bottom:3px;"><img id="subscribe-button" src="<?php echo $root_server_url ?>/images/video.svg" title="Subscribe" style="width: 48px; height: 32px;"></a><a target="_blank" href="subscribe.php" onclick="event.stopPropagation(); return true;" style="margin-bottom:3px;"><img id="subscribe-button" src="<?php echo $root_server_url ?>/images/video.svg" title="Subscribe" style="width: 48px; height: 32px;"></a>
								</div>
