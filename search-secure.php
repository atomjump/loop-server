...
<html lang="en">
  <head>
		 ...
		 <meta name="keywords" content="<?php echo $msg['msgs'][$lang]['keywords'] ?>">
			...
			<script type="text/javascript" src="<?php echo $root_server_url ?>/js/chat-inner-1.3.23.js"></script> 
							...
							<?php if($granted == true) { ?>
								...
								<div class="form-group col-xs-12 col-sm-12 col-md-5 col-lg-4">
									...
									<a target="_blank" href="<?php 
										$feedback_id = date("His", strtotime($layer_info['date_owner_start'])) . "-" . $_REQUEST['uniqueFeedbackId'] . $layer_info['date_owner_start'];
									if($cnf['video']['url']) {
