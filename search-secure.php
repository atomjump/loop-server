...
<html lang="en">
  <head>
	...
	<body class="comment-popup-body">
		...
		<div id="comment-single-msg" class="comment-frm-scroller" style="display: block; z-index: 11000; width: <?php echo $_REQUEST['width'] ?>px; height: <?php echo $_REQUEST['height'] ?>px;">
