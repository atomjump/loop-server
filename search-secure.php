<?php 
 ...
 //Internal frame that appears within the popup
	...
	if(isset($cnf['chatInnerJSFilename']) && (file_exists(__DIR__ . $cnf['chatInnerJSFilename']))) {
		...
		//The default version
		$chat_inner_js_filename = "/js/chat-inner-1.3.32.js";			//This should be updated when the Javascript file
			...
			echo $msg['msgs'][$lang]['saveSettingsButton'];
									...
									<?php global $cnf;
										...
										<div id="set-forum-password-form" class="form-group" style="display:none;">
											<div><?php echo $msg['msgs'][$lang]['setForumPass'] ?> <a href="javascript:" onclick="$('#forum-password-explain').slideToggle();" title="<?php echo $msg['msgs'][$lang]['setForumPassReason'] ?>"><?php echo $msg['msgs'][$lang]['optional'] ?></a>  <span id="forum-password-explain" style="display: none;  color: #f88374;"><?php echo $msg['msgs'][$lang]['setForumPassReasonExtended'] ?></span>&nbsp;<a href="javascript:" onclick="$('#set-forum-password').val('-');"><img src="images/bin.svg" width="14" height="14"></a></div>
