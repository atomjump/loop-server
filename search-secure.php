				   ...
				   <form id="comment-input-frm" class="form form-inline" role="form" action="" onsubmit="return mg.commitMsg(sendPublic);"  autocomplete="off" method="GET">
							...
							<?php if($granted == true) { ?>
								...
								<div class="form-group col-xs-12 col-sm-12 col-md-5 col-lg-4">
									...
									<a target="_blank" href="https://appear.in/aj-<?php echo $_REQUEST['uniqueFeedbackId'] ?>" onclick="if(iOS == true) { return false; } else { return true; };" style="margin-bottom:3px;"><img id="video-button" src="<?php echo $root_server_url ?>/images/video.svg" title="Video Chat" style="width: 48px; height: 32px;"></a>
								</div>
