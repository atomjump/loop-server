			...
			echo $msg['msgs'][$lang]['saveSettingsButton'];
									...
									<?php global $cnf;
										...
										<div id="set-forum-password-form" class="form-group" style="display:none;">
											<div><?php echo $msg['msgs'][$lang]['setForumPass'] ?> <a href="javascript:" onclick="$('#forum-password-explain').slideToggle();" title="<?php echo $msg['msgs'][$lang]['setForumPassReason'] ?>"><?php echo $msg['msgs'][$lang]['optional'] ?></a>  <span id="forum-password-explain" style="display: none;  color: #f88374;"><?php echo $msg['msgs'][$lang]['setForumPassReasonExtended'] ?></span>&nbsp;&nbsp;<a href="javascript:" onclick="$('#set-forum-password').val('-');"><img src="images/close.svg" width="12" height="12"></a></div>
