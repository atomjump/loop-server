...
<html lang="en">
  <head>
		 ...
		 <meta name="keywords" content="<?php echo $msg['msgs'][$lang]['keywords'] ?>">
			...
			<script type="text/javascript" src="<?php echo $root_server_url ?>/js/chat-inner-1.3.14.js"></script> 
	...
	<body class="comment-popup-body">
		 <div id="layer-title"><?php if(isset($layer_info['var_title'])) { echo $layer_info['var_title']; } ?></div>
